...
Info  : https://brightdata.jp/products/insights/price-tracker/tabelog
"""
...
# https://brightdata.jp/products/web-scraper/tabelog
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Tabelog scraper at: https://brightdata.jp/products/web-scraper/tabelog\n"
